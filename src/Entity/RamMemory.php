 ...
 * RamMemory
 *
 * @ORM\Table(name="ram_memory", indexes={@ORM\Index(name="id_sub_cat_ram_memory_fk", columns={"id_subcategory"}), @ORM\Index(name="id_product_ram_memory_fk", columns={"id_porduct"})})
 * @ORM\Entity
 */
class RamMemory
{

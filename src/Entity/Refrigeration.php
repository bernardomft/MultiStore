 ...
 * Refrigeration
 *
 * @ORM\Table(name="refrigeration", indexes={@ORM\Index(name="id_sub_cat_refrigeration_fk", columns={"id_subcategory"}), @ORM\Index(name="id_product_refrigeration_fk", columns={"id_porduct"})})
 * @ORM\Entity
 */
class Refrigeration
{
